...
class Healty_info extends CI_Controller {
	...
	public function index()	{
		...
		$data = array(
			...
			'_content' => 'front_end/healthy_info/healthy_info'
		);
	...
	public function detail1()	{
		...
		$data = array(
			'page_title' => $page_title,
			'_content' => 'front_end/healthy_info/detail_healthy_info1'
		);
	...
	public function detail2()	{
		...
		$data = array(
			'page_title' => $page_title,
			'_content' => 'front_end/healthy_info/detail_healthy_info2'
		);
	...
	public function detail3()	{
		...
		$data = array(
			'page_title' => $page_title,
			'_content' => 'front_end/healthy_info/detail_healthy_info3'
		);
	...
	public function detail4()	{
		...
		$data = array(
			'page_title' => $page_title,
			'_content' => 'front_end/healthy_info/detail_healthy_info4'
		);
	...
	public function detail5()	{
		...
		$data = array(
			'page_title' => $page_title,
			'_content' => 'front_end/healthy_info/detail_healthy_info5'
		);
	...
	public function detail6()	{
		...
		$data = array(
			'page_title' => $page_title,
			'_content' => 'front_end/healthy_info/detail_healthy_info6'
		);
	...
	public function detail7()	{
		...
		$data = array(
			'page_title' => $page_title,
			'_content' => 'front_end/healthy_info/detail_healthy_info7'
		);
	...
	public function detail8()	{
		...
		$data = array(
			'page_title' => $page_title,
			'_content' => 'front_end/healthy_info/detail_healthy_info8'
		);
	...
	public function detail9()	{
		...
		$data = array(
			'page_title' => $page_title,
			'_content' => 'front_end/healthy_info/detail_healthy_info9'
		);
	...
	public function detail10()	{
		...
		$data = array(
			'page_title' => $page_title,
			'_content' => 'front_end/healthy_info/detail_healthy_info10'
		);
