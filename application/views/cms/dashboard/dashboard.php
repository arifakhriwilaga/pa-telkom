            ...
            <li class="item">
              ...
              <div class="">
                <a href="javascript:void(0)" class="product-title">Senin
                  <span class="label label-warning pull-right">12.00</span></a>
            ...
            <li class="item">
              ...
              <div class="">
                <a href="javascript:void(0)" class="product-title">Selasa
                  <span class="label label-info pull-right">21.00</span></a>
                    <span class="product-description">
                      27/02/2018
                    </span>
              </div>
            ...
            <li class="item">
              ...
              <div class="">
                <a href="javascript:void(0)" class="product-title">Kamis
                  <span class="label label-success pull-right">08.46</span></a>
                    <span class="product-description">
                      1/03/2018
                    </span>
              </div>
            ...
            <li class="item">
              ...
              <div class="">
                <a href="javascript:void(0)" class="product-title">Jumat
                  <span class="label label-success pull-right">09.00</span></a>
                    <span class="product-description">
                      2/03/2018
                    </span>
              </div>
