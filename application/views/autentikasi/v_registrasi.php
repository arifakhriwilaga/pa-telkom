            ...
            <div class="col-md-5 col-center form-account" style="position:absolute;left:25%;right:25%;">
                <div class="box">
                    <div class="panel-form basic-form form" style="margin:15px 0">
                        ...
                        <br>
                        <div id="section-form">
                            <form action="<?php echo site_url('c_autentikasi/lakukan_registrasi'); ?>" method="POST" id="form-user" class="form-horizontal" style="padding-left:15px;padding-right:15px">
                                <div class="form-group">
