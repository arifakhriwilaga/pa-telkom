                    ...
                    <div class="head_top_social pull-right">
                        <span class="head-customer">
                            ...
                            <a data-toggle="popover" href="#" style="color: #2c3e50">
                                <img src="<?php echo($user['foto'] ? base_url($user['foto']) : base_url('assets/images/home/header/default-avatar.png')); ?>" onerror="imgError(this);" alt="Avatar" class="avatar-header">
