      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header" style="background-color:#6ab04c;color:#fff">
            ...
            <h4 class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-book" style="text-align: center;
    margin: auto;"></i> Hasil Diagnosa Penyakit Sementara</h4>
          </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header" style="background-color:#f0932b;color:#fff">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-spoon" style="font-size:24px"></i> Lihat Rekomendasi Makanan</h4>
          </div>
          <div class="modal-body">
            St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm
          </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header" style="background-color:#eb4d4b;color:#fff">
            ...
            <h4 class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-file"></i> Surat Hasil Keterangan Sementara</h4>
          </div>
          <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
                    <table class="table">
                        <tr>
                            <td style="width:150px;border-top:0">Nama</td><td style="width:10px;border-top:0">:</td><td style="border-top:0">Rinez Asprinola</td>
                        </tr>
                        <tr>
                            <td style="width:150px;border-top:0">Usia</td><td style="width:10px;border-top:0">:</td><td style="border-top:0">20 Tahun</td>
                        </tr>
                        <tr>
                            <td style="width:150px;border-top:0">Tanggal Lahir</td><td style="width:10px;border-top:0">:</td><td style="border-top:0">12 April 1997</td>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <p> St Lorem ipsum dolor, grou ingotm ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm. <br>
            St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm <br>
            St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm </p>
            </div>
          </div>
          <div class="modal-footer" style="text-align:center">
            ...
            <button type="button" data-dismiss="modal" class="btn btn-login btn-lg" style="min-width:130px;margin-top:15%;font-size:18px;background-color:#b2bec3;border-color:#b2bec3;height:45px;min-width:80px;padding-top:9px">OK</button>
    ...
    <div class="modal fade" id="modal5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header" style="background-color:#f6b93b;color:#fff">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-glass"></i> Hasil Saran Penyakit Yang Di Derita</h4>
          </div>
          <div class="modal-body">
            St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm St Lorem ipsum dolor, grou ingotufmm
          </div>
    ...
    <div class="modal fade" id="modal6" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header" style="background-color:#686de0;color:#fff">
            
            <h4 class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-print"></i> Surat Prediksi Penyakit Sementara</h4>
          </div>
          <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
