        ...
        <div class="col-md-10 col-center form-account">
            <div class="panel-form basic-form form">
             <h2 style="text-align: left;color:#e67e22">Selamat Datang di Pemeriksaan Gejala Kesehatan Online</h2>
                ...
                <hr>
                <form style="padding-left:25px;padding-right:25px;padding-top: 10px;">
                ...
                <div class="form-group">
                    <select id="check-search" name="check-search" style="width: 300px;max-height: 300px" value=""><option></option></select>
                </div>
                </div>
                <div class="col-md-6">
...
<div class="container">
    <div class="row">
        <div class="col-md-10 col-center form-account">
            <div class="panel-form basic-form form">
             <h2 style="text-align: left;color:#e67e22">Batuk</h2><hr>
                <form style="padding-left:50px;padding-right:50px;">
                    <div class="form-group">
                        <div class="row">
                        <label for="" class="col-md-9">Apakah batuk yang Anda rasakan baru terjadi akhir-akhir ini? ?</label>
                        <label class="col-md-3">
                            <label class="col-md-6">
                                <input type="radio" name="" id="" class="col-md-2"> Ya
                            </label>
                            <label class="col-md-6">
                                <input type="radio" name="" id="" class="col-md-2"> Tidak
                            </label>
                        </label>
                        </div>
                    </div>
