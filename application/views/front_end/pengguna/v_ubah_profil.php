            ...
            <div class="col-md-5 col-center">
                <div class="box">
                    <div class="panel-form basic-form form">
                        <h2>Edit Profile</h2>
                        <form action="<?php echo site_url('front_end/c_profil/update_profil/'.$user['user_id']); ?>" method="POST" enctype="multipart/form-data" id="edit-profile" class="form-horizontal" style="padding-left:15px;padding-right:15px">
