...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 16, 2018 at 04:52 AM
...
INSERT INTO `cetak_riwayat` (`id_cetak`, `id_user`, `tanggal_dibuat`) VALUES
(1, 2, '2018-07-04 14:46:47'),
(2, 2, '2018-07-04 23:40:12'),
(3, 2, '2018-07-14 23:47:19'),
(4, 10, '2018-07-16 02:46:31'),
(5, 10, '2018-07-16 02:50:35'),
(6, 10, '2018-07-16 02:50:58'),
(7, 10, '2018-07-16 02:51:07');
...
(1, 3, '2018-07-02 11:42:31'),
(2, 1, '2018-07-03 13:56:44'),
(3, 3, '2018-07-04 14:45:15'),
(4, 1, '2018-07-04 23:40:24'),
(5, 1, '2018-07-15 11:29:56'),
(6, 1, '2018-07-16 02:46:53');
...
INSERT INTO `konsul_dokter` (`id_konsul`, `id_user`, `nomor_dokter`, `pertanyaan_konsul`, `status_pertanyaan`, `jawaban_konsul`, `status_notif`, `tgl_konsul`, `tgl_kirim`) VALUES
(5, 2, 3, 'hallo bu nami', 'true', 'iya ushop?', 'baca', '2018-07-04 14:37:27', '2018-07-04 16:42:27');
...
CREATE TABLE `penyakit` (
  ...
  `saran_solusi` text NOT NULL,
  `rekomendasi_makanan` text NOT NULL,
  `link_you_tube` varchar(250) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `periksa` (`id_periksa`, `id_user`, `id_penyakit`, `tanggal_dibuat`) VALUES
(1, 2, 5, '2018-07-02 23:09:09'),
(2, 2, 5, '2018-07-02 23:09:36'),
(3, 2, 5, '2018-07-02 23:12:04'),
(4, 2, 5, '2018-07-02 23:13:05'),
(5, 2, 5, '2018-07-04 14:45:35'),
(6, 2, 1, '2018-07-04 14:46:35'),
(7, 2, 5, '2018-07-04 14:49:35'),
(8, 2, 5, '2018-07-04 14:49:45'),
(9, 2, 5, '2018-07-04 23:40:09'),
(10, 2, 5, '2018-07-14 22:46:12'),
(11, 2, 5, '2018-07-14 22:47:06'),
(12, 2, 5, '2018-07-14 22:49:01'),
(13, 2, 5, '2018-07-14 22:49:45'),
(14, 2, 4, '2018-07-14 22:50:47'),
(15, 2, 1, '2018-07-14 22:51:20'),
(16, 2, 1, '2018-07-14 22:52:13'),
(17, 10, 5, '2018-07-16 02:46:28'),
(19, 10, 9, '2018-07-16 02:47:59'),
(20, 10, 1, '2018-07-16 02:50:33');
...
CREATE TABLE `tahap_pemeriksaan` (
  ...
  `pertanyaan_masuk` int(11) DEFAULT NULL,
...
INSERT INTO `tahap_pemeriksaan` (`id_pemeriksaan`, `pertanyaan`, `id_gejala`, `pertanyaan_masuk`, `status`, `penyakit_benar`, `penyakit_salah`) VALUES
...
CREATE TABLE `user` (
  ...
  `foto_berkas` varchar(60) DEFAULT NULL,
...
INSERT INTO `user` (`id_user`, `username`, `nama_user`, `email`, `jk_user`, `tgl_lahir`, `password`, `level_user`, `remember`, `cookie`, `foto`, `nip`, `foto_berkas`, `tgl_registrasi`) VALUES
(1, 'admin', 'admin', 'admin@gmail.com', 'male', '2018-07-02', '21232f297a57a5a743894a0e4a801fc3', 'admin', '0', '1LmNVusrfRPzIJX2kgEKoO1X6eb3gQ8W5rvFhiQoS4dsbI7EuwWmYYejMBqiyhK0', '/uploads/foto/_foto_profil_20180716013630.jpg', '', '', '2018-07-16 02:46:53'),
(2, 'ushop', 'ushop', 'ushop@gmail.com', 'male', '1998-12-16', 'e158cfbb057f12c8a1909b36f983601d', 'dokter', '0', 'tn5IS7JMfsBeCa0D6RjLpmT4eCNV7gvqltTwZZpXkaQcFhbuO6GYXPEG3WgVBJOS', '/uploads/foto/ushop_foto_profil_20180716020916.jpg', '', '', '2018-07-16 00:23:00'),
(3, 'nami', 'nami', 'nami@gmail.com', 'female', '1998-12-09', '1a34268cf4d5356d69badfc8b53303b4', 'dokter', '0', '486YH4mBodS0xvk2fwJScN7GVguZ1RnFCXIlJAyhlpyAq97hn05NCjVY6I2OrwkW', '/uploads/foto/nami_foto_profil_20180716014506.jpg', '345678901011129090', '', '2018-07-16 00:23:14'),
(4, 'asd', 'asd', 'asd@asd.com', 'male', '1998-12-21', 'a8f5f167f44f4964e6c998dee827110c', 'user', '', '', '', '', '', '2018-07-15 04:31:45'),
(5, 'hana', 'hana', 'hanaervani@gamil.com', 'female', '1998-12-28', '9f67caf75350d412b74adb69a229c5f1', 'user', '', '', '', '', '', '2018-07-15 04:39:26'),
(6, 'sanji', 'sanji', 'sanji@gmail.com', 'male', '1998-12-01', '726db02e2ad1f1155fb54dcd56e492fe', 'user', '0', 'gcl1h2Dr8j9RDpY9BtZoeITuGmsYdeCK5kPS2L8KC7BgwUOl4Jx3MXXSJ0WwHVn1', '', '', '', '2018-07-15 12:35:45'),
(7, 'zoro', 'zoro', 'zoro@gmai.com', 'male', '1998-12-09', '66ed61f32365c5c66c6797609cd37839', 'user', '', '', '', '', '', '2018-07-15 12:40:41'),
(8, 'ajeng', 'ajeng', 'ajeng@gmail.com', 'female', '1998-12-17', '2a78fe15f01ed8753c83004dfb0ff471', 'user', '', '', '', '', '', '2018-07-15 12:59:40'),
(9, 'pepi', 'pepi', 'pepi@gmail.com', 'female', '1998-12-30', '5b02f405a28480c4b3da9f8f5dd51fdd', 'user', '', '', '', '', '', '2018-07-15 13:00:32'),
(10, 'agus', 'agus', 'agus@gmail.com', 'male', '1998-12-29', '94ac4e4843f12fa3b8d46fa0a8b34d02', 'user', '0', 'yXGdVepb8f1yRYhQ33SYjutItz5gSeMHqnUzPAg4xWcjnaJa5k9WXhQk94Z812KZ', '', '', '', '2018-07-16 02:47:32');
...
ALTER TABLE `konsul_dokter`
  ...
  ADD KEY `doctor_id` (`nomor_dokter`),
  ADD KEY `user_id` (`id_user`);
...
--
ALTER TABLE `jadwal_login`
  MODIFY `id_history_login` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `konsul_dokter`
  ADD CONSTRAINT `konsul_dokter_ibfk_1` FOREIGN KEY (`nomor_dokter`) REFERENCES `user` (`id_user`),
